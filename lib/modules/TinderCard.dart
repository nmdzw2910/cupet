...
enum TriggerDirection { none, right, left, up, down, reverse }
...
class _TinderSwapCardState extends State<TinderSwapCard>
  ...
  Future<void> triggerReverse() async {
    if (_currentFront == widget._totalNum - widget._stackNum) {
    ...
    setState(() {
      try {
        ...
        _currentFront++;
        print('Current Front: $_currentFront');
        //     int index = widget._totalNum - widget._stackNum - _currentFront;
        // widget._currentIndex = index;
        print('Total Num: ${widget._totalNum}');
        print('Stack Num: ${widget._stackNum}');
        print('Current INdex: ${widget._currentIndex}');
      } catch (e) {
        print('Nope');
        print(e);
        print(_cardAligns);
      ...
      // print('Change Order  Now !');
    });
  }

  void triggerSwap(TriggerDirection trigger) {
    if (trigger == TriggerDirection.reverse) {
      print(trigger);
      triggerReverse();
      return;
    }
...
class CardController {
  ...
  void triggerReverse() {
    if (_listener != null) {
      _listener(TriggerDirection.reverse);
    }
  }
